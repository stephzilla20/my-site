      ...
      <main className='mt-16 caret-transparent bg-snowstorm-2 px-10 dark:bg-polarnight-4'>
        <div className="flex flex-col items-start mx-3 lg:mx-64">
            ...
            <p className='font-inter text-polarnight-2 dark:text-snowstorm-2 text-lg leading-7 pb-10 '>
              I took my first CS course in grade 11 entirely through Zoom in the middle of COVID. Now, I'm pursuing a computer science degree at Toronto Metropolitan University! I'm also currently part of my schools CS course union (CSCU) as well as the TMU's <span className='text-frost-1 dark:text-frost-3 '><a href="https://gdsc.community.dev/toronto-metropolitan-university-toronto-canada/">Google DSC</a></span>.</p>
