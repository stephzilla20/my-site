...
export default function BottomBar(){
  ...
  return (
    ...
    <div className=' mt-8 text-4xl text-frost-1-custom dark:text-snowstorm-1-custom flex justify-center space-x-8 '>
      ...
      <a className="hover:text-frost-2 dark:hover:text-snowstorm-1" href='https://drive.google.com/file/d/1MMMsK6ju8_qAZNNKrzJVSCENMK3VJ8-b/view' target="_blank"><IoMdDocument/></a>
    </div>
