        ...
        <section className="bg-snowstorm-2 min-h-screen dark:bg-polarnight-4 transition duration-500 ease-in-out">
          ...
          <div className='p-10'>
            ...
            <p className='font-Varela text-polarnight-2 dark:text-snowstorm-2 text-lg leading-7 pb-10'>
              I'm currently a <span className='text-frost-1 dark:text-frost-3 transition duration-500 ease-in-out'>second year</span> co-op student at Toronto Metropolitan University (Ryerson) studying computer science. You'll most likely find me at the gym, on the ball court, in the kitchen cooking, or learning the latest technologies. I've recently started learn photography and photo editing. Currently I'm interested in <span className='text-frost-1 dark:text-frost-3'>web development</span> and hope to learn more about <span className='text-frost-1 dark:text-frost-3'>cloud development</span> and <span className='text-frost-1 dark:text-frost-3'>cyber security</span>. Feel free to connect with my below or check out my resume at the top! 
            </p>
          </div>
